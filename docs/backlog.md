...
| V1-P4 | P2 | in_progress | agent | Phase 4: Daily checks + iteration | SessionStart hook surfaces daily capture stats. Run `measure_capture.py --days 7` weekly. Decide v1.2 direction after ~10 sessions of data. |
## Done
